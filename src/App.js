...
const project = {
  gmailclone: {title: "Gmail Clone",tags: ['React','CSS','Express','Mongo DB'],description: 'Gmail Clone with all the details and information',backend_code: 'https://github.com/NamagiriLakshmiMVL/Gmail-Clone-Backend.git',frontend_code: 'https://github.com/NamagiriLakshmiMVL/Gmail-Clone-Frontend.git',fe_deployed_link: 'https://namagiri-gmail-clone-frontend.netlify.app/',backend_deployed_link: 'https://backend-jz6x.onrender.com',source: Gmail},
  store_management: {title: "Store Management",tags: ['React','CSS','Express','Mongo DB'],description: 'Store Management is a website developed for selling fruits and vegetables online with all the information included and the bill is also generated',backend_code: 'https://github.com/NamagiriLakshmiMVL/STORE_MANAGEMENT.git',frontend_code: 'https://github.com/NamagiriLakshmiMVL/STORE_MANAGEMENT_FRONTEND.git',fe_deployed_link: 'https://namagiri-store-management.netlify.app/',backend_deployed_link: 'https://store-management-backend-1.onrender.com',source: Store},
  moneymanager: {title: "Money Manager",tags: ['React','CSS','Express','Mongo DB'],description: 'Manager for your expense / expenditure. Record your transactions and Plan Accordingly',backend_code: 'https://github.com/NamagiriLakshmiMVL/Money_Manager_Backend.git',frontend_code: 'https://github.com/NamagiriLakshmiMVL/Money-Manager.git',fe_deployed_link: 'https://namagiri-expense-tracker.netlify.app/',backend_deployed_link: 'https://money-manager-backend-9lok.onrender.com',source: Money},
  billing_app: {title: "Billing App",tags: ['React','CSS','HTML'],description: 'Billing App to bill the products for each item with price and quantity',backend_code: '',frontend_code: 'https://github.com/NamagiriLakshmiMVL/billing.git',fe_deployed_link: 'https://namagiribilling.netlify.app/',backend_deployed_link: '',source: Bill},
  Shopping_cart: {title: "Shopping Cart",tags: ['React','CSS'],description: 'Shopping Cart with basic features of cart page',backend_code: '',frontend_code: 'https://github.com/NamagiriLakshmiMVL/redux.git',fe_deployed_link: 'https://namagiri-shopping-cart-redux.netlify.app/',backend_deployed_link: '',source : Cart},
  }
  ...
  return (
    ...
    <Box sx={{flex:0.7,display: "flex",alignItems:'center',flexDirection:"column"}}>
      ...
      <Box sx={{display: "flex",flexDirection: "column",alignItems:"center",border: "1px solid grey",borderRadius: "3px",boxShadow: "10px 10px 20px #aaa",width: "150px"}} p={5}>
        ...
        <Typography><a style={{color: "#111",letterSpacing: 1}} href='https://www.linkedin.com/in/namagiri-lakshmi-aa5b87262/' target='__blank' rel="noopener noreferrer">Linked In</a></Typography>
      </Box>
      <Box sx={{display: "flex",flexDirection: "column",alignItems:"center",border: "1px solid grey",borderRadius: "3px",boxShadow: "10px 10px 20px #aaa",width: "150px"}} p={5}>
        <GitHubIcon fontSize='large'/>
        <Typography variant='h5' p={1} sx={{fontWeight: "600"}}>Github</Typography>
        <Typography><a style={{color: "#111",letterSpacing: 1}}  href='https://github.com/NamagiriLakshmiMVL' target='__blank' rel="noopener noreferrer">Github</a></Typography>
      </Box>
      </Box>
    </Box>
    </Box>
    <Box sx={{color: "white",backgroundImage : 'linear-gradient(45deg, #333,#555)'}} p={2} mt={15}>
      <Typography variant='h7' sx={{display: "flex",justifyContent:"center"}}>{new Date().getFullYear()} - Designed and Developed By - Namagiri</Typography>
    </Box>
    </div>
  );
}
